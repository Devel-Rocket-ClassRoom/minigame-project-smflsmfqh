...
namespace CartoonFX
{
    ...
    public partial class CFXR_Effect : MonoBehaviour
    {
        ...
        static readonly int _GameObjectWorldPosition = Shader.PropertyToID(
            "_GameObjectWorldPosition"
        );
        ...
        public class AnimatedLight
        {
            ...
            public class AnimatedLightDrawer : PropertyDrawer
            {
                ...
                static GUIContent[] ModePopupLabels = new GUIContent[]
                {
                    new GUIContent("Curve"),
                    new GUIContent("Perlin Noise"),
                };
                ...
                )
                {
                    ...
                    if (animateIntensity.boolValue)
                    {
                        startIndent(ref rect);
                        {
                            ...
                            int val = EditorGUI.Popup(
                                rect,
                                IntensityModeLabel,
                                perlinIntensity.boolValue ? 1 : 0,
                                ModePopupLabels
                            );
                            rect.y += propSpace;
        ...
        void Awake()
        {
            ...
            if (
                particleRenderer.sharedMaterial != null
        ...
        [System.NonSerialized]
        ParticleSystem _parentParticle;
        ...
        [System.NonSerialized]
        public bool editorUpdateRegistered;

        [System.NonSerialized]
        bool particleWasStopped;
        ...
        public void RegisterEditorUpdate()
        {
            ...
            if (
                type is PrefabAssetType.Regular or PrefabAssetType.Variant
        ...
        void onEditorUpdate()
        {
            ...
            if (
                ...
                && rend.sharedMaterial.IsKeywordEnabled("_CFXR_LIGHTING_WPOS_OFFSET")
            )
            {
                if (materialPropertyBlock == null)
                {
            ...
            if (particleTime != parentParticle.time)
            {
                ...
                if (
                    cameraShake != null
                    && cameraShake.enabled
                    && parentParticle.time < particleTime
    ...
    public class CFXR_Effect_Editor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.HelpBox(
                "Camera Shake has been globally disabled in the code.\nThe properties remain to avoid data loss but the shaking won't be applied for any effect.",
                MessageType.Info
            );
#endif
        ...
        void GlobalOptionsGUI()
        {
            EditorGUILayout.BeginVertical(PaddedRoundedRect);
            {
                ...
                bool lightPreview = EditorGUILayout.Toggle(
                    "Light Animations",
                    lightEditorPreview.Value
                );
                ...
                {
                    shakeEditorPreview = EditorPrefs.GetBool(
                        "CFXR CameraShake EditorPreview",
                        true
                    );
                }
                bool shakePreview = EditorGUILayout.Toggle(
                    "Camera Shake",
                    shakeEditorPreview.Value
                );
